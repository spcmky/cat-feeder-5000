# Cat Feeder 5000 — Shared Parameters
# 1:1 translation of params.scad. Single source of truth for CadQuery parts.
...
HALO_TUBE_OD = 24        # Halo tube outer diameter (params.scad global)
...
# ===== COLORS (RGBA, for assembly visualization) =====
