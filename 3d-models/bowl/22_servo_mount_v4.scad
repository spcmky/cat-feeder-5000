...
// shaft sits 30.9mm up from the pocket's "bottom" (see params_v4 SERVO_SHAFT_OFFSET)
POCKET_BOTTOM_Z = HINGE_Z - SERVO_SHAFT_OFFSET;
...
echo("Servo shaft center (local bracket coords): X =", BX, " Y =", BY/2, " Z =", HINGE_Z);
