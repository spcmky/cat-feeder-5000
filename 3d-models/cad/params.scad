...
ARCH_SPAN = 160;         // Antenna arch left-to-right span
ARCH_H = 70;             // Antenna arch height
ARCH_D = 40;             // Antenna arch depth (front-to-back)
COIL_CH_W = 16;          // Coil channel width
COIL_CH_D = 5;           // Coil channel depth
